...
// Deliberately duplicated from BookmarkTypes.BookmarkTypeIcons rather than shared across
// features - matches this codebase's existing convention of each feature slice owning its
// logic rather than reaching into another feature folder.
internal static class AttachmentTypeIcons
{
        ...
        out string? error)
    {
        ...
        {
            // No icon supplied - that's fine, an attachment type's icon is optional.
            return true;
        }
