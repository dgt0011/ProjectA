...
public interface IToDoService
{
    ...
    /// </returns>
    Task<List<ToDoItem>> GetList(bool includeDone = false, CancellationToken cancellationToken = default);
    ...
    Task<ToDoItem?> GetById(uint id, CancellationToken cancellationToken = default);
}
