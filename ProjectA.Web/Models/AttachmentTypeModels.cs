...
// Matches the shape returned by every AttachmentTypes endpoint (list item, get-by-id, and the
...
public sealed class AttachmentTypeDto
{
...
// handler from an uploaded IFormFile (see AttachmentTypes/Create.cshtml.cs) rather than bound
...
public sealed class AttachmentTypeInput
{
